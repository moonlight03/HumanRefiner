...
parser.add_argument('--sub', help='', default='bike')
...
print(args.sub)
print(os.getcwd())
human = args.sub # youtube2 youtube3 youtube5 youtube_test youtube_bee sora zju_377 zju_386 zju_387 zju_392 zju_393 zju_394
...
smpl_parms_path = f'data/{human}/test'
