...
def render_batch(points, shs, colors_precomp,normals_precomp, rotations, scales, opacity, FovX, FovY, height, width, bg_color,
    ...
    rendered_normal, _, _ = rasterizer(
        ...
        means2D = screenspace_points,
        shs = shs,
        colors_precomp = normals_precomp,
        opacities = opacity,
        scales = scales,
        rotations = rotations,
        cov3D_precomp = cov3D_precomp)
    
    return rendered_image,rendered_normal