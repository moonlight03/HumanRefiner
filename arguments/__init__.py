...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.finrtuning_milestones = [int(self.epochs / 4), int(self.epochs / 2),int(self.epochs* 3 / 4)]
